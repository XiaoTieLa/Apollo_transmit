...
export declare enum ClientBinaryOpcode {
    MESSAGE_DATA = 1,
...
export declare enum FetchAssetStatus {
    SUCCESS = 0,
    ERROR = 1
}
...
export type ClientMessage = Subscribe | Unsubscribe | ClientAdvertise | ClientUnadvertise | GetParameters | SetParameters | SubscribeParameterUpdates | UnsubscribeParameterUpdates | ClientMessageData | ServiceCallRequest | SubscribeConnectionGraph | UnsubscribeConnectionGraph | FetchAsset;
